...
export const TEMPLATES = [
  ...
  },
  {
    ...
    defaultLayout: {
      ...
      portrait:        { row: 1,  col: 9,  rowSpan: 1, colSpan: 4 },
      ...
      traits:          { row: 9,  col: 1,  rowSpan: 1, colSpan: 4 },
      subclassFeats:   { row: 9,  col: 5,  rowSpan: 1, colSpan: 4 },
      abilities:       { row: 10, col: 1,  rowSpan: 1, colSpan: 4 },
      equipment:       { row: 9,  col: 9,  rowSpan: 1, colSpan: 4 },
