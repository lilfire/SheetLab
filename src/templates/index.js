...
export const TEMPLATES = [
  ...
  },
  {
    ...
    defaultLayout: {
      ...
      portrait:        { row: 1, col: 9,  rowSpan: 2, colSpan: 4, settings: { showHeader: false, aspectRatio: '4/2', showMask: true } },
      ...
      passive:         { row: 6, col: 4,  rowSpan: 2, colSpan: 3 },
      insp:            { row: 7, col: 1,  rowSpan: 1, colSpan: 3, style: { accentColor: '#000000' } },
      saving:          { row: 4, col: 5,  rowSpan: 2, colSpan: 4, visible: false },
      combat:          { row: 1, col: 5,  rowSpan: 1, colSpan: 4, settings: { showHeader: false } },
      hp:              { row: 4, col: 1,  rowSpan: 3, colSpan: 3 },
      hitdice:         { row: 4, col: 4,  rowSpan: 1, colSpan: 3 },
      deathsaves:      { row: 5, col: 4,  rowSpan: 1, colSpan: 3 },
      ...
      attacks:         { row: 8, col: 1,  rowSpan: 1, colSpan: 12, settings: { lineCount: 6 } },
      ...
      notes:           { row: 4, col: 7,  rowSpan: 4, colSpan: 6, settings: { lineCount: 12 } },
    },
