...
export const TEMPLATES = [
  {
    ...
    defaultLayout: {
      ...
      subclassFeats:   { row: 11, col: 1, rowSpan: 1, colSpan: 1 },
  ...
  },
  {
    ...
    defaultLayout: {
      ...
      subclassFeats:   { row: 8, col: 3, rowSpan: 1, colSpan: 1 },
  ...
  },
  {
    ...
    defaultLayout: {
      ...
      portrait:        { row: 1, col: 9,  rowSpan: 2, colSpan: 4, settings: { showHeader: false } },
      raceclass:       { row: 2, col: 1,  rowSpan: 2, colSpan: 5, settings: { showExperience: false, showProficiencyBonus: false, showBackgroundAlignment: false, showCharacterFeatures: false, showCharacterTraits: false } },
      background:      { row: 10, col: 1,  rowSpan: 1, colSpan: 4, visible: false },
      ability:         { row: 4, col: 1,  rowSpan: 1, colSpan: 12 },
      passive:         { row: 2, col: 6,  rowSpan: 2, colSpan: 3 },
      insp:            { row: 3, col: 9,  rowSpan: 1, colSpan: 4 },
      saving:          { row: 4, col: 5,  rowSpan: 2, colSpan: 4, visible: false },
      combat:          { row: 6, col: 1,  rowSpan: 1, colSpan: 4 },
      hp:              { row: 5, col: 5,  rowSpan: 3, colSpan: 4 },
      deathsaves:      { row: 5, col: 1,  rowSpan: 1, colSpan: 4 },
      featurePrimary:  { row: 14, col: 5,  rowSpan: 2, colSpan: 4, visible: false },
      traits:          { row: 14, col: 1,  rowSpan: 1, colSpan: 4, visible: false },
      featureSecondary:{ row: 9, col: 9,  rowSpan: 2, colSpan: 4, visible: false },
      abilities:       { row: 15, col: 1,  rowSpan: 1, colSpan: 4, visible: false },
      subclassFeats:   { row: 17, col: 5,  rowSpan: 1, colSpan: 4, visible: false },
